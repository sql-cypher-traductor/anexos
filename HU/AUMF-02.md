<table>
    ...
    <tr>
        <td colspan=2>
            ...
            <ul>
                <li>Se debe mostrar el listado de los usuarios registrados.</li>
                <li>Cada usuario registrado debe incluir opciones para actualización de información o eliminación de la cuenta.</li>
            </ul>
        </td>
    </tr>
</table>