<table>
    ...
    <tr>
        <td colspan=2>
            ...
            <ul>
                <li>Se debe mostrar el listado de conexiones almacenadas.</li>
                <li>Se debe mostrar estados de las conexiones.</li>
                <li>Se debe mostrar opciones para modificación o eliminación de conexiones.</li>
            </ul>
        </td>
    </tr>
</table>