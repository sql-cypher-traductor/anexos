<table>
    ...
    <tr>
        <td colspan=2>
            ...
            <ul>
                <li>El formulario debe solicitar el email del usuario.</li>
                <li>Se debe redireccionar a un formulario para establecer una nueva contraseña.</li>
                <li>Se debe confirmar mediante correo el restablecimiento de la contraseña.</li>
            </ul>
        </td>
    </tr>
</table>