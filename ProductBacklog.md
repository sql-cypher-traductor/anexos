<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><b>Como</b> administrador,<br><b>Quiero</b> gestionar (actualizar y/o eliminar) la información de los usuarios,<br><b>Para</b> controlar el acceso y uso correcto a la aplicación.</td>
            <td>13</td>
        </tr>
        <tr>
            <td rowspan=4>CON</td>
        ...
        <tr>
            <td>CON-04</td>
            <td>Gestión y visualización de conexiones</td>
            <td><b>Como</b> desarrollador,<br><b>Quiero</b> visualizar el esquema de la base de datos relacional,<br><b>Para</b> poder escribir consultas válidas.</td>
            <td>13</td>
        </tr>
        <tr>
            <td rowspan=6>QTE</td>
